...
import type { H17Deviation, H17DeviationSet } from "./apToolboxH17Pro";
...
// AP Toolbox's supplied S17 Pro chart: 32 entries including the two
// unconditional late-surrender plays and insurance (4-8 decks).
const AP_TOOLBOX_S17_PRO_ROWS: readonly Row[] = [
  ["Insurance", "A", 3, "N", "I"],
...
/** The supplied AP Toolbox S17 Pro catalog: dealer stands on soft 17. */
export const S17_PRO_DEVIATIONS = make("apToolboxS17Pro", AP_TOOLBOX_S17_PRO_ROWS);
