...
export default function PrivacyPage() {
  return (
    <>
      ...
      <p className="mt-2 text-[var(--ink-muted)]">Last updated August 15, 2026.</p>
      <div className="mt-7 space-y-5">
        ...
        <Panel>
          ...
          <ul className="mt-3 space-y-2 text-sm leading-6 text-[var(--ink-muted)]">
            <li>&bull; <b className="text-[var(--ink)]">Email/password:</b> handled by Supabase Auth. CountLab stores your email address and an encrypted password hash; the plaintext password is never stored or visible to CountLab.</li>
            <li>&bull; <b className="text-[var(--ink)]">Google sign-in:</b> Google shares your name, email, and profile photo with CountLab (via Supabase) to create your account. CountLab does not receive your Google password. Google&rsquo;s own privacy policy governs what Google itself collects when you use this option.</li>
            <li>&bull; <b className="text-[var(--ink)]">Guest mode:</b> no account is created. Training records and settings stay on your device unless you later sign in. First-party usage analytics are sent under a random device identifier as described below.</li>
          </ul>
        </Panel>
        <Panel>
