...
const catalogs = H17_PRO_DEVIATIONS.map((row) => ({ ...row, catalog: "H17 Pro" }));
...
export default function DeviationReferencePage() {
  ...
  return <>
    ...
    <p className="mt-2 text-zinc-400">H17 Pro deviations: 34 plays for 4–8 deck H17 games.</p>
    <Panel className="mt-7">
      <div className="rounded-2xl border border-emerald-400/15 bg-emerald-400/[.06] p-4 text-sm text-zinc-300">
        <p>Based exactly on the supplied H17 Pro charts. The catalog includes insurance, split, soft-total, hard-total, and late-surrender decisions. “Always” means the chart marks the surrender as a standing H17 late-surrender play rather than a count threshold.</p>
