    ...
    <>
      ...
      <Panel className="mt-7">
        <div className="rounded-2xl border border-emerald-400/15 bg-emerald-400/[.06] p-4 text-sm text-zinc-300">
          <p>This is a compact 17-play FreeBJ reference, not a claimed complete index matrix. “FreeBJ baseline” is the source catalog&rsquo;s no-surrender action, not a replacement for your selected table&rsquo;s basic strategy. CountLab applies a departure only when that source baseline matches the selected rule-specific basic action; otherwise keep basic strategy. The set contains no insurance or surrender departures.</p>
        ...
        <div className="mt-3 overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead className="text-zinc-500"><tr><th className="p-2">Player hand</th><th className="p-2">Dealer</th><th className="p-2">Index</th><th className="p-2">FreeBJ baseline</th><th className="p-2">Departure</th><th className="p-2">Surrender departure</th></tr></thead>
