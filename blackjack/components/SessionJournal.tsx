        ...
        >
          <div onChange={() => sessionForm.start("inputs")}>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
              ...
              <Select label="Play variation" value={useIndices ? "indices" : "basic"} onChange={(event) => setUseIndices(event.target.value === "indices")}><option value="indices">Pro indices</option><option value="basic">Basic strategy only</option></Select>
            </div>
