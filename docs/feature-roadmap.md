...
This roadmap converts the useful workflows observed in the reference product into original
...
- Real session and bankroll journal (`lib/blackjack/journal.ts`,
  ...
  ledger. Unlike the reference product Results Tracker, a session's theoretical EV and
...
the reference product Results Tracker (`docs/reference-analysis.md`) validated the
